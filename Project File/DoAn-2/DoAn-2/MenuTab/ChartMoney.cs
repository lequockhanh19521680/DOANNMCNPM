...
namespace DoAn_2.MenuTab
{
    public partial class ChartMoney : Form
    {
        ...
        {
            ChartRead.Series["Series1"].XValueType = ChartValueType.DateTime;

            ChartRead.ChartAreas[0].AxisX.LabelStyle.Format = "dd-MM";
            ...
            adapt.Fill(DanhSach);
            ChartRead.DataSource = DanhSach;
            //set the member of the chart data source used to data bind to the X-values of the series  
            ChartRead.Series["Series1"].XValueMember = "Ngay";
            //set the member columns of the chart data source used to data bind to the X-values of the series  
            ChartRead.Series["Series1"].YValueMembers = "tien";
            ChartRead.Series["Series1"].IsValueShownAsLabel = true;
